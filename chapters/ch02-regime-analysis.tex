...
\begin{table}[H]
\centering
\caption{\rl{مشخصات نظام جمهوری اسلامی}}
...
\hline
\end{tabular}
\caption{\rl{نهادهای ایدئولوژیک و بودجه تخمینی}}
\end{table}
...
\begin{table}[H]
\centering
\caption{\rl{نیروهای نیابتی جمهوری اسلامی}}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        xticklabels={\rl{۱۳۷۸}, \rl{۱۳۸۸}, \rl{۱۳۹۶}, \rl{۱۴۰۱}, \rl{۱۴۰۴}},
        width=12cm,
        height=7cm,
        grid=major,
