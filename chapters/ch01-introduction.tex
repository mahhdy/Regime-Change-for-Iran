...
\end{tikzpicture}
\captionof{figure}{ایران در دوراهی سرنوشت‌ساز}
\end{center}
...
\end{tikzpicture}
\captionof{figure}{خط زمانی اعتراضات مهم ایران}
\end{center}
...
\begin{table}[H]
\centering
\caption{نقشه راهنمای مطالعه}
\begin{tabular}{|C{2cm}|L{6cm}|C{3cm}|}
\hline
\rowcolor{iranblue!20}
\textbf{سطح} & \textbf{توضیح} & \textbf{فصول پیشنهادی} \\
\hline
سریع & خلاصه وضعیت و توصیه‌ها & فصل ۰ \\
\hline
متوسط & درک کلی از وضعیت و سناریوها & فصول ۱-۴ \\
\hline
عمیق & تحلیل جامع و آمادگی اجرایی & همه فصول \\
\hline
تخصصی & پژوهش و ارجاع آکادمیک & پیوست‌ها \\
\hline
\end{tabular}
\end{table}
