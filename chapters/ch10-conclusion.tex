...
\begin{tikzpicture}[scale=0.9, transform shape]
    ...
    % Text
    \node[concept, scale=1.2, fill=white, draw=iranblue] at (0,0) {\rl{آزادی و دموکراسی}};
    
    \node[below=4.5cm of goal, align=center, font= \small \color{iranblue!70}] at (0,0) {\rl{افق روشن ایران فردا}};
\end{tikzpicture}
\captionof{figure}{\rl{پایان استبداد و طلوع آزادی}}
\end{center}
